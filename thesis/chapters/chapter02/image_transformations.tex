...
(Figure \ref{fig:curvelet_frequency_windows_angular}). These windows can be
combined in $U_j$ (Figure \ref{fig:curvelet_frequency_windows_combined}):
\begin{equation*}
...
1$. The construction of the corner windows are 
Figure \ref{fig:curvelet_frequency_windows_discrete} shows a tiling of
all $U_{j, l}^D$.
