...
algorithms as used in \autocite{nister_scalable_2006} and \autocite
{philbin_object_2007}, that recursively divide or merge partitions to optimize
the vocabulary.
...
distance metrics and similarity measure candidates, that can be used to that
end.
