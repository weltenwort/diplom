...
coefficient for COS and HI exceed all previous results. In an attempt to
improve the result further, several sets of parameter values are examined: For
the number of angles $N_{\theta} \in \{8, 12, 16\}$, no improvement is visible.
