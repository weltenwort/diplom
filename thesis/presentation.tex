...
\begin{frame}{Anatomy of a CBIR System}
    %\begin{columns}
        %\begin{column}{0.5\textwidth}
            \begin{figure}
                \includegraphics[height=.8\textheight]{illustrations/cbir_anatomy_query_cropped}
...
\begin{frame}{Global Feature Extraction (Sampling)}
    \begin{description}
        \item[MEAN] Calculate the mean coefficients on $n \times n$ grid, concatenate across scales and angles
    \end{description}
    \begin{columns}
        \begin{column}{.5\textwidth}
            \begin{figure}
